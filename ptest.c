...
int main(int argc, char **argv) {
    ...
    stringSpan_args * args5;

    for(args5 = strspn_args; args5->function_name != NULL; args5++) {
        result = stringSpan(args5->str1, args5->str2);
        printf("%s(%s, %s) = %d", args5->function_name, args5->str1, args5->str2, result);
    ...
    endianExperiment_args * args6;

    for(args6 = endianExp_args; args6->function_name != NULL; args6++) {
        result = endianExperiment(args6->s);
        printf("%s = %d", args6->function_name, result);
